...
let __ocaml_lex_tables = {
  Lexing.lex_base =
   "\000\000\228\255\229\255\230\255\231\255\001\000\234\255\235\255\
    \236\255\237\255\238\255\239\255\240\255\241\255\242\255\243\255\
    \244\255\245\255\246\255\021\000\248\255\003\000\031\000\033\000\
    \078\000\088\000\253\255\251\255\249\255\232\255\233\255\002\000\
    \053\000\254\255\049\000\255\255";
  Lexing.lex_backtrk =
   "\255\255\255\255\255\255\255\255\255\255\026\000\255\255\255\255\
    \255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
    \255\255\255\255\255\255\008\000\255\255\026\000\005\000\003\000\
    \001\000\000\000\255\255\255\255\255\255\255\255\255\255\255\255\
    \255\255\255\255\001\000\255\255";
  Lexing.lex_default =
   "\002\000\000\000\000\000\000\000\000\000\031\000\000\000\000\000\
    \000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
    \000\000\000\000\000\000\255\255\000\000\255\255\255\255\255\255\
    \255\255\255\255\000\000\000\000\000\000\000\000\000\000\031\000\
  ...
  Lexing.lex_trans =
   "\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
    ...
    \000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
    \000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
    \004\000\021\000\005\000\030\000\030\000\000\000\000\000\000\000\
    \010\000\009\000\018\000\016\000\006\000\017\000\015\000\019\000\
    \025\000\025\000\025\000\025\000\025\000\025\000\025\000\025\000\
    \025\000\025\000\008\000\007\000\022\000\020\000\023\000\029\000\
    \028\000\024\000\024\000\024\000\024\000\024\000\024\000\024\000\
    \024\000\024\000\024\000\024\000\024\000\024\000\024\000\024\000\
    \024\000\024\000\024\000\024\000\024\000\024\000\024\000\024\000\
    \024\000\024\000\024\000\012\000\027\000\011\000\026\000\034\000\
    \035\000\024\000\024\000\024\000\024\000\024\000\024\000\024\000\
    \024\000\024\000\024\000\024\000\024\000\024\000\024\000\024\000\
    \024\000\024\000\024\000\024\000\024\000\024\000\024\000\024\000\
    \024\000\024\000\024\000\014\000\000\000\013\000\024\000\024\000\
    \024\000\024\000\024\000\024\000\024\000\024\000\024\000\024\000\
    \025\000\025\000\025\000\025\000\025\000\025\000\025\000\025\000\
  ...
  Lexing.lex_check =
   "\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
    ...
    \255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
    \255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
    \000\000\000\000\000\000\005\000\031\000\255\255\255\255\255\255\
    \000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
    \000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
    ...
    \000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
    \000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
    \000\000\000\000\000\000\000\000\022\000\000\000\023\000\032\000\
    \034\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
    \000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
    \000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
    \000\000\000\000\000\000\000\000\255\255\000\000\024\000\024\000\
    \024\000\024\000\024\000\024\000\024\000\024\000\024\000\024\000\
    \025\000\025\000\025\000\025\000\025\000\025\000\025\000\025\000\
    ...
    \255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
    \255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
    \000\000\005\000\031\000\255\255\255\255\255\255\255\255\255\255\
    \255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
    \255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
    \255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
    \255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
...
let rec tiger_token lexbuf =
   __ocaml_lex_tiger_token_rec lexbuf 0
...
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
                     ...
                     ( Tokens._INT (Int.of_string inum, Lexing.lexeme_start lexbuf, Lexing.lexeme_end lexbuf) )
...
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
                            ...
                            ( Tokens._STRING ((String.sub s ~pos:1 ~len:(String.length s - 2)), Lexing.lexeme_start lexbuf, Lexing.lexeme_end lexbuf) )
  ...
  | 26 ->
        ...
        ( (ErrorMsg.error (Lexing.lexeme_start lexbuf) "Invalid token"); Tokens._EOF (Lexing.lexeme_start lexbuf, Lexing.lexeme_end lexbuf) )
...
;;
    ...
    try (ignore (parse lexbuf); raise Missing_exception) with ErrorMsg.Error -> ();
      [%expect {| :1.18: Invalid token |}]

    let%expect_test "parse_invalid_symbol_second_line" =
    let lexbuf = Lexing.from_string "let type arrtype = array of\n5`4" in
    try (ignore (parse lexbuf); raise Missing_exception) with ErrorMsg.Error -> ();
      [%expect {| :2.2: Invalid token |}]
